...
const StudentAllSemesterResult = () => {
  return (
    <>
      <div className="2xl:container mx-auto flex flex-row w-full h-auto border">
        ...
        <section className="2xl:container mx-auto border border-rose-800 w-full p-6 rounded-2xl shadow-lg">
          <div className="border">
            <h1 className="text-md mb-4 text-neutral-700 dark:text-neutral-300 font-bold">Consolidated Result</h1>
          </div>
        </section>
      </div>
    </>
...
export default StudentAllSemesterResult